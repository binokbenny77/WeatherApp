package com.dev.ahoyweatherapp.util

import androidx.annotation.VisibleForTesting
import androidx.lifecycle.LiveData
import androidx.lifecycle.Observer
import com.dev.ahoyweatherapp.db.entity.*
import com.dev.ahoyweatherapp.domain.model.*
...
fun generateCitiesForSearchEntity(id: String, name: String): CitiesForSearchEntity {
    return CitiesForSearchEntity("Clear", "Turkey", CoordEntity(34.0, 30.0), name,"true" ,"Beyoglu", 1, id)
}
